...
namespace WilokeCounter\Controllers\TaxonomyFeaturedImage;
...
class TaxonomyFeaturedImageController
{
  ...
  private function hasTermList(): bool
  {
    ...
    $configPath = WILOKE_WILOKECOUNTER_VIEWS_PATH .
        ...
        <div>
          <p>
            <input type="button"
                   ...
                   value="<?php _e('Add Image', 'wiloke-counter'); ?>">
            <input type="button"
