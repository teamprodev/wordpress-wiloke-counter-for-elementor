...
use WilokeCounter\Share\TraitHandleAutoRenderSettingControls;
use WilokeCounter\Share\TraitImageSizes;
...
class PluginAddon extends Widget_Base
{
	...
	{
		try {
			Timber::$locations = WILOKE_WILOKECOUNTER_VIEWS_PATH . 'src/Views';
            ...
            <p class="wil-element-warning wil-element-text-center">
				<?php esc_html_e('Something went error!', 'wiloke-counter'); ?>
